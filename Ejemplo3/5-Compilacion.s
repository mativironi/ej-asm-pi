...
/* >Abrimos el terminal(Shell) y nos ubicamos donde se encuentra nuestro fichero. Ej: ej1.s    

    1)  as -o ej1.o ej1.s     @ Crea un archivo objeto
	2)	ld -o ej1 ej1.o       @ Crea un archivo ejecutable	
	3)  ./ej1 ; echo $?       @ Ejecuta 
